...
public class HyphenBankSeed
{
	...
	public HyphenBankSeed(String pbUserKeyStr)
	{
		SeedEncRoundKey(sRoundKey, SUtil.s2b(pbUserKeyStr));
	}

	public HyphenBankSeed(byte pbUserKey[])
	{
...
//System.out.println("cbc_encrypt 1.before padding ("+sbuf.length+":"+KSBankSeed.hex_encode(sbuf)+")");

		byte[] inData = addPadding(sbuf,PKCS5_PADDING,SeedBlockSize);

//System.out.println("cbc_encrypt 2.after padding ("+inData.length+":"+KSBankSeed.hex_encode(inData)+")");
...
//System.out.println("cbc_encrypt 3."+j+" "+KSBankSeed.hex_encode(xOutput)+" = "+KSBankSeed.hex_encode(xInput)+" ^ "+KSBankSeed.hex_encode(inData)+" ");

			//SeedEncrypt(inData,j, sRoundKey, encData,j);
			SeedEncrypt(xOutput,0, sRoundKey, encData,j);

//System.out.println("cbc_encrypt 4.after padding ("+KSBankSeed.hex_encode(xOutput)+")");
